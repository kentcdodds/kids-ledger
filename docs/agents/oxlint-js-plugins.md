...
- Plugin name: `kids-ledger-custom`
- Rule id: `no-example-identifier`
- Config key: `kids-ledger-custom/no-example-identifier`
...
You should see a lint error from `kids-ledger-custom/no-example-identifier`.
